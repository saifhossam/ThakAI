...
- PyMuPDF and Docling were ineffective for text extraction since the PDFs appear to use encoded text, resulting in unreadable output and preventing reliable preprocessing or text normalization so I scraped the text using crawl4ai from the urls attached in the assessment.
